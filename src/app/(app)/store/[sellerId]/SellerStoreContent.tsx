...
export function SellerStoreContent({ sellerId }: { sellerId: string }) {
                    ...
                    <div className="flex items-start gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          {typeof store.pickupAddress === 'string' 
                            ? store.pickupAddress 
                            : `${store.pickupAddress.street}, ${store.pickupAddress.lga}, ${store.pickupAddress.state}`}
                        </p>
                      </div>
                    </div>
                  )}
