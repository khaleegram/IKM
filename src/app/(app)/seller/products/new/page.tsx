...
export default function NewProductPage() {
    ...
    <div className="flex flex-col h-full bg-muted/30">
      <header className="p-4 md:p-6 bg-background border-b sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Create a new product listing for your store</p>
          </div>
      ...
      <main className="flex-1 overflow-auto p-4 md:p-6">
        <form ref={formRef} id="product-form" onSubmit={handleSubmit}>
                      ...
                      {variants.length === 0 ? (
                        <div className="text-center py-8 border-2 border-dashed rounded-lg">
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() => {
                              setVariants([{ name: '', options: [{ value: '', priceModifier: '', stock: '', sku: '' }] }]);
                            }}
                          >
                        ...
                        variants.map((variant, variantIdx) => (
                          <Card key={variantIdx} className="border-2">
                            <CardHeader className="pb-3">
                              <div className="flex items-center justify-between">
                                <CardTitle className="text-base">Variant {variantIdx + 1}</CardTitle>
                                <Button
                                  type="button"
                                  variant="ghost"
                                  size="icon"
                            ...
                            <CardContent className="space-y-4">
                              ...
                              <div className="space-y-2">
                                ...
                                {variant.options.map((option, optIdx) => (
                                  <div key={optIdx} className="flex gap-2 items-start p-3 border rounded-lg">
