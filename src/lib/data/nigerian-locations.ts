...
export const NIGERIAN_STATES: State[] = [
  ...
  },
  {
    name: "Cross River",
    code: "CR",
    lgas: ["Abi", "Akpabuyo", "Akamkpa", "Bakassi", "Bekwarra", "Biase", "Boki", "Calabar Municipal", "Calabar South", "Etung", "Ikom", "Obanliku", "Obubra", "Obudu", "Odukpani", "Ogoja", "Yakuur", "Yala"]
  },
  {
    name: "Delta",
    code: "DE",
