...
```ts
import { useAddNewReview, useGetProductReviews, useUpdateProductInventory, useListProductsByCategory } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useUpdateProductInventory(updateProductInventoryVars);
...
```js
import { addNewReview, getProductReviews, updateProductInventory, listProductsByCategory } from '@dataconnect/generated';
...
// Operation UpdateProductInventory:  For variables, look at type UpdateProductInventoryVars in ../index.d.ts
